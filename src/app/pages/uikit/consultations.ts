    ...
    template: `<div class="card">
        <p-tabs value="0">
            <p-tablist>
                ...
                <p-tab value="1">Create Appointments</p-tab>
            </p-tablist>
            <p-tabpanels>
                <p-tabpanel value="0">
                        ...
                        <p-table [value]="appointments" stripedRows>
                            ...
                            <ng-template pTemplate="body" let-appointment>
                                <tr>
                                    ...
                                    <td>
                                        <p-tag [value]="appointment.billingStatus" [severity]="appointment.billingStatus == 'Paid' ? 'success' : appointment.billingStatus == 'Pending' ? 'warn' : 'danger'"></p-tag>
                                    </td>
                                    <td>
                                        <p-tag [value]="appointment.assessmentStatus" [severity]="appointment.assessmentStatus == 'Completed' ? 'success' : appointment.assessmentStatus == 'In Progress' ? 'info' : 'danger'"></p-tag>
                                    </td>
                                    <td>
...
export class ConsultationsComponent implements OnInit {
    ...
    isFormDisabled(): boolean {
        return !(this.selectedPatient && this.appointmentDate && this.appointmentTime && this.department && this.doctor && this.reason && this.priority && this.status);
    }
