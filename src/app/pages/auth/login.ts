...
@Component({
  ...
  <div>
    ...
    <input pInputText id="email1" type="text" placeholder="Username" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200" [(ngModel)]="username" />
  </div>
  ...
  <div class="mt-4">
    ...
    <p-button label="Log In" styleClass="w-full mt-8 bg-blue-600 hover:bg-blue-700 dark:bg-purple-600 dark:hover:bg-purple-700" (onClick)="onLogin()"></p-button>
  </div>
</div>
    `
})
export class Login {
    ...
    constructor(private supabaseService: LoginserviceService, private router: Router,
